...
the version available from LANL. Full text of the [GPLv3 License](https://github.com/losalamos/FaQCs/blob/master/LICENSE) can be found in the License file in the main development 
